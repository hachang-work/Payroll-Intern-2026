          ...
          {selectedRowIds.size > 0 && (
            <div className="flex items-center justify-between px-4 py-2 bg-rose-50/90 dark:bg-rose-950/40 border-b border-rose-200 dark:border-rose-800 shrink-0 text-rose-900 dark:text-rose-100 shadow-xs relative z-[130]">
              <div className="flex items-center gap-2 text-xs font-bold">
                ...
                <span>Đã chọn <strong className="font-mono text-rose-700 dark:text-rose-300 text-sm">{selectedRowIds.size}</strong> dòng</span>
              </div>
              ...
              {showFooter && (
                ...
                >
                  ...
                  >
                    {selectable && (
                      <td
                        className={`border-b border-r border-t ${borderClass} ${footerClassName || "bg-[var(--table-column-header-bg,#F4ECD8)]"}` + ` ${(footerClassName || "").includes("text-") ? "" : "text-slate-800"} font-bold ${stickyFirstColumn ? "sticky-col-selectable sticky-footer-col" : "sticky-footer-col"} total-row`}
                        style={{
                          position: "sticky",
                          bottom: 0,
                    ...
                    {isRowNumberVisible && (
                      <td
                        className={`border-b border-r border-t ${borderClass} ${footerClassName || "bg-[var(--table-column-header-bg,#F4ECD8)]"}` + ` ${(footerClassName || "").includes("text-") ? "" : "text-slate-800"} font-bold ${stickyFirstColumn ? "sticky-col-row-number sticky-footer-col" : "sticky-footer-col"} total-row`}
                        style={{
                          position: "sticky",
                          bottom: 0,
                          zIndex: stickyFirstColumn ? 45 : 30,
