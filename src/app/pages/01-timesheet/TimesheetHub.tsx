      ...
      <AnimatePresence initial={false}>
        {view === "final" && (
          <motion.div
            ...
            style={{ paddingTop: "0px", paddingBottom: "12px", paddingLeft: "0px", paddingRight: "0px" }}
          >
                ...
                >
                  ...
                  >
                    ...
                    >
                      {/* Always show Summary */}
                      <div 
                        className="animate-in fade-in slide-in-from-top-2 duration-300 shrink-0 overflow-hidden"
                        style={{ paddingTop: "12px", height: "66.9924px" }}
                      >
                    ...
                    >
                      ...
                      <div className="flex flex-col gap-1 relative">
                        <span 
                          className="font-mono text-[9px] tracking-[0.1em] uppercase text-foreground/60 font-bold leading-none"
                        >
                          KEYWORD
                        </span>
                        <div className="relative">
                          <DebouncedSearchInput
                            ...
                            className="bg-card rounded-lg pl-8 pr-3 py-1.5 border border-border hover:border-accent focus:border-accent focus:outline-none transition-all w-full text-xs font-bold text-foreground shadow-2xs"
                          />
                    ...
                    <div 
                      className="actions mt-auto border-t border-[var(--border)] w-full shrink-0 flex flex-col gap-2"
                      style={{ paddingLeft: "6px", paddingRight: "6px", paddingTop: "6px", paddingBottom: "6px", height: "92.6534px" }}
                    >
                      <DropdownMenu>
                      ...
                      <button 
                        ...
                        style={{ height: "25.7557px", fontSize: "10.2px", paddingTop: "0px", paddingBottom: "0px" }}
                      >
                        Cấu hình
                      </button>
                    </div>
