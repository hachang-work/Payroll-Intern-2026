    ...
    <div className="flex-1 flex flex-col min-h-0 bg-transparent overflow-hidden">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-bold uppercase tracking-wider text-primary text-[12px]">
            BẢNG TỔNG HỢP GIỜ LÀM VIỆC THEO NHÂN VIÊN
          </h3>
        </div>
        <div className="flex items-center gap-4">
          <div className="flex flex-col items-end">
            <span className="text-[9px] font-bold text-foreground/60 uppercase tracking-tighter whitespace-nowrap">NHÂN VIÊN</span>
