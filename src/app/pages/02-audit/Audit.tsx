        ...
        >
          ...
          >
            <div className="flex min-w-0 items-center gap-3">
              ...
              {/* Only display active table name, no border, no background, hide other table name */}
              <div className="flex items-center gap-2 text-xs font-black uppercase tracking-wide px-1 py-0.5 select-none">
                {activeTab === "main" ? (
                  <>
                    <FileText className="w-4 h-4 text-primary shrink-0" />
                    <span className="text-primary font-extrabold">BẢNG TỔNG QUAN AUDIT</span>
                    {mainData.length > 0 && (
                      <span className="text-[10px] px-2 py-0.5 rounded-full font-mono font-bold bg-primary/10 text-primary">
                        {mainData.length}
                      </span>
                    )}
                  </>
