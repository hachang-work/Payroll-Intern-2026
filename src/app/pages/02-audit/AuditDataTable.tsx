            ...
            >
              ...
              <thead className="sticky top-0 z-[60] bg-white">
                ...
                {columns.some(c => c.group) && (
                  <tr className="h-[30px]">
                    {showRowNumber && (
                      <th 
                        rowSpan={2} 
                        className={`sticky top-0 z-[70] w-[50px] min-w-[50px] text-center bg-[#F8FAFC] dark:bg-slate-800 border-b border-r border-[var(--grid-line-color,#CBD5E1)] py-1 text-[var(--header-font-size,0.6875rem)] font-bold uppercase text-slate-800 dark:text-slate-200`}
                ...
                <tr className={`h-[30px] ${headerClassName ? "" : "bg-[#F8FAFC]"}`}>
                  ...
                  {showRowNumber && !columns.some(c => c.group) && (
                    <th
                      className={`sticky top-0 z-[60] w-[50px] border-b border-r border-[var(--grid-line-color,#CBD5E1)] text-center ${headerClassName ? headerClassName : "bg-[#F8FAFC]"} text-[var(--header-font-size,0.6875rem)] font-bold uppercase text-slate-800 dark:text-slate-200`}
                      style={{ padding: "var(--table-padding, 0.25rem 0.4rem)", verticalAlign: "middle" }}
                    >
                      No.
                    </th>
              ...
              {showFooter && (
                ...
                >
                  {/* Grand Total Row */}
                  <tr
                    className={`${footerClassName || "bg-[var(--table-column-header-bg,#F4ECD8)]"} ${(footerClassName || "").includes("text-") ? "" : "text-slate-800"} font-bold border-t border-slate-300 total-row`}
                  >
                    {selectable && (
                      <td
                    ...
                    {visibleColumns.map((col: any, cIdx: number) => {
                      ...
                      return (
                        <td
                          ...
                          className={`whitespace-nowrap font-bold border-b border-t border-slate-300 ${cIdx === visibleColumns.length - 1 ? "border-r-0" : "border-r border-[#E2E8F0]"} ${getAlignment(col)} uppercase text-[0.75rem] ${footerClassName || "bg-[var(--table-column-header-bg,#F4ECD8)]"} ${(footerClassName || "").includes("text-") ? "" : "text-slate-800"} ${col.footerClassName || ""}`}
                          style={{
