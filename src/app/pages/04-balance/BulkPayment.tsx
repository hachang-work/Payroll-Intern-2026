              ...
              {activeLeftTab === "summary" && (
                ...
                >
                  ...
                  <div
                    ...
                    style={{ height: "55.8636px" }}
                  >
                    <div 
                      className="master-payout-glow absolute top-0 right-0 w-28 h-28 rounded-full blur-2xl -mr-12 -mt-12 transition-all" 
                    ...
                    <div className="flex items-baseline gap-1.5 relative z-10">
                      <p
                        className="text-[24px] font-black text-primary-foreground font-mono tracking-tighter leading-none"
                        style={{ fontSize: "24px" }}
                      >
                  ...
                  <div className="flex flex-col gap-3" style={{ height: "290.089px" }}>
                        ...
                        <div className="payroll-theme-card border rounded-xl p-3 flex flex-col gap-1.5 shadow-sm transition-colors">
                          ...
                          >
                            ...
                            >
                              ...
                              <option value="IV" className="text-sky-900 font-bold text-[10px] bg-white">IV. RECONCILIATION</option>
                            </select>
                            <ChevronDown
              ...
              {rightPanelTab === "table" && (
                ...
                >
                  <DataTable
                    ...
                    footerClassName="bg-[var(--table-column-header-bg,#F4ECD8)] text-slate-800 border-[#e7dbdc] font-bold"
                  />
                </motion.div>
              )}
                    ...
                    <table className="w-full min-w-max text-left border-separate border-spacing-0 text-[11px] font-sans">
                      ...
                      >
                        <tr>
                          <th
                            rowSpan={2}
                            className="group relative px-1.5 py-1 font-bold uppercase tracking-wider text-[9px] w-12 text-center border-r border-b border-slate-300 align-middle whitespace-normal cursor-pointer select-none"
